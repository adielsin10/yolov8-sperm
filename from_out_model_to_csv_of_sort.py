...
# ⚙️ נתיבים:
labels_folder = r"C:\tracformer_modle\trackformer-sperm\progect_yolov8\yolo_output\FKY1 SR1\labels"  # הנתיב לקבצי ה-TXT של YOLO
output_csv = r'yolo_output\sort_input_FKY1_SR1.csv'   # הנתיב לקובץ ה-CSV של SORT
image_width = 256
image_height = 256
